...
import com.lxgs.cms.dubbo.api.OtherChannelDetailDubboService;
 ...
 * 盛大小贷
 */
@Service(interfaceName = "com.lxgs.cms.dubbo.api.OtherChannelDetailDubboService", validation = "true", version = "1.0.0", timeout = 30000)
