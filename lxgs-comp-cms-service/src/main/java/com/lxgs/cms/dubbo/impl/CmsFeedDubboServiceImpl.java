...
import com.lxgs.cms.dubbo.api.CmsFeedDubboService;
import com.lxgs.cms.dubbo.api.pojo.CmsFeedVo;
 ...
 */
@Service(interfaceName = "com.lxgs.cms.dubbo.api.CmsFeedDubboService", version = "1.0.0", timeout = 30000)
